  ...
  <table width="590" border="0" cellspacing="0" cellpadding="2" class="texto1" id="aba_produtos">
    ...
    <tr>
      ...
      <td>
        ...
        <input type="hidden" tabindex="10" size="10" name="qtd_caixas" value="<?php if($i['qtd_caixa']=="0"){ echo "1 ";}else{ echo $i[qtd_caixa]; };?>">
      ...
      ?>
      <input type="hidden" name="estoque" id="estoque" value="<?php echo $Estoque;?>">
      <td valign="top" align="right" width="10">&nbsp;Ipi</td>
      <td valign="top">
        &nbsp;<input type="text"  style="width: 60px; border: 1px solid #aba8a8; background-color:#FFFFFF; text-align: right;" size="8" name="ipi_cc" tabindex="12" dir="rtl" value="<?php echo $i['ipi'];?>" id="ipi_cc" size="8" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.ped.valor_unitario1_cc.focus();}">
      </td>
    ...
    <tr>
      ...
      <td>&nbsp;<input name="valor_unitario1_cc" dir="rtl" id="valor_unitario1_cc" style="width: 60px; border: 1px solid #aba8a8; background-color:#FFFFFF; text-align: right;" value="<?php echo $ValorUnitario1;?>" type="text" size="8" maxlength="20" onfocus="this.select()" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){calculavalor(); if (this.value){if (document.ped.desconto.value>0){if (document.getElementById('display_especial').value=='block'){document.ped.valor_unitario2_cc.focus();}else{if (document.getElementById('Ok').style.display!='none'){ document.ped.Ok.focus(); }}}else{ if (document.getElementById('Ok').style.display!='none'){ document.ped.Ok.focus(); } }}}else{this.focus();}"></td>
    ...
    <tr>
      ...
      <td colspan="3" width="top">
        ...
        <input type="text" style="width: 300px; border: 1px solid #aba8a8; background-color:#FFFFFF; text-align: left;" size="75" name="descricao_cc" value='<?php echo $Nome;?>' id="descricao_cc" onclick="this.value=''; document.getElementById('buscaProdutos').style.display='block'; document.getElementById('btn_procurar').focus();" onkeyup="this.value=''; document.getElementById('buscaProdutos').style.display='block'; document.getElementById('btn_procurar').focus();">
            ...
            ?>        
        <BR>
        <div id="UltimosItens" style="display:none;border: 0px solid; position:absolute;  background:transparent; z-index: 99999;"><?php include("vendas/ultimos_itens_pedido.php");?></div>        
