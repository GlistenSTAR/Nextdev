...
<table border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
  <tr>
    <td>Endereço:</td>
    <td>
      <input name="endereco" id="endereco" value="<? echo strtoupper($cep[logradouro]);?>" type="text" size="35" maxlength="50" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.endereco_numero.focus();}">
      Número:
      <input name="endereco_numero" id="endereco_numero" value="<? echo strtoupper($cep[log_complemento]);?>" type="text" size="8" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.cidade.focus();}"></td>
  </tr>
  <tr>
    <td>Cidade:</td>
  ...
  <tr>
    ...
    <td><input name="codigo_ibge" id="codigo_ibge" value="<? echo "$Ibge[codigo_ibge]";?>" type="text" size="10" maxlength="10" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.ddd.focus();}"></td>
  </tr>
  <?}else{?>
