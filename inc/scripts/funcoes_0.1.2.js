...
//      ValorUnitario1 = Math.round(ValorUnitario * Fator1 * 100)/100;
      ValorUnitario1 = Math.round(ValorUnitario * 1000)/1000;
      ValorUnitario11 = Math.round(ValorUnitario * 1000)/1000;
      Alterado1="S";
    }else{
      if (d.desconto1_cc){
...
//      ValorUnitario2 = Math.round(ValorUnitario22 * Fator2 * 100)/100;;
      ValorUnitario2 = Math.round(ValorUnitario22 * 1000)/1000;;
//      Alterado2="S";
...
//    valor_unitario10 = valor_unitario_cheio * Fator1 ;
    ...
    d.valor_unitario1_cc.value = Math.round(valor_unitario10*1000)/1000;
  }else{
...
//    valor_unitario20 = valor_unitario_cheio * Fator2 ;
    ...
    d.valor_unitario2_cc.value = Math.round(valor_unitario20*1000)/1000;
  }else{
...
function calculavalor(){
  ...
  d[campo1].value = (Math.round((d[campo1].value * 1000)))/1000;
  d[campo2].value = (Math.round((d[campo2].value * 1000)))/1000;
