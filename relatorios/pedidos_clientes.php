...
//                          }
                          ...
                          <tr>
                            ...
                            <td width="40"><a href='#' onclick="Acha('relatorios/pedidos_clientes.php','pagina=<? echo $pagina;?>&pedidos_clientes_id=<?=$_REQUEST[pedidos_clientes_id]?>&pedidos_clientes_cc=<?=$_REQUEST[pedidos_clientes_cc]?>&ordem=data&pos=<? if ($_REQUEST[ordem]=="data"){ echo $pos;}else{echo $pos1;}?>&data_inicial='+document.listar.data_inicial.value+'&data_final='+document.listar.data_final.value+'','Conteudo');"><b>Data</b><img src="icones/<? if ($_REQUEST[ordem]=="data"){ echo $pos;}else{echo $pos1;}?>.gif" border="0" width="10" height="10"></a></td>
                          ...
                          while ($r = pg_fetch_array($not1)){
                            ...
                            <tr bgcolor="<? echo "$Cor";?>" onMouseOver="this.bgColor = '#C0C0C0'" onMouseOut ="this.bgColor = '<? echo "$Cor";?>'">
                              ...
                              <td valign="top" align="right">
                                <? echo number_format($r[total_com_desconto], 2, ",", ".");?>
                              </td>
                              <td align="center">
                                <?
                                if ($Status=="Cancelado"){
