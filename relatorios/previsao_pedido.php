...
<form name="listar">
  <div id="listar">
    <table width="580" height="300" border="0" cellspacing="0" cellpadding="0" class="texto1">
      ...
      <tr>
        <td align="center">
          <b>Pesquisa de Previsão de Pedido</b>
        </td>
      </tr>
      <tr>
        <td><img src="images/spacer.gif" width="1" height="3"></td>
                                ...
                                <td valign="top">
                                  <div id="cpanel">
                                    <div style="float: left;">
                                     	<div class="icon">
                                        <input type="button" name="Ok" value="Ok" border="0" id="Ok" style="width: 20px; height: 16px;"  onclick="listarpedidos('previsao_pedido');">
                                     	</div>
                                    </div>
                                  </div>
                                </td>
                            ...
                            <table width="100%" border="0" class="texto1">
                              ...
                              if ($ccc<>""){
                                ...
                                <tr>
                                  ...
                                  $proximo = $pc +1;
                                  if ($pc>1) {
                                    echo "<a href='#' onclick=\"Acha('relatorios/previsao_pedido.php','pagina=$anterior&ordem=$_REQUEST[ordem]&pedidos_clientes_id=$_REQUEST[pedidos_clientes_id]&pedidos_clientes_cc=$_REQUEST[pedidos_clientes_cc]&pos$pos&data_inicial=$_REQUEST[data_inicial]&data_final=$_REQUEST[data_final]','Conteudo');\"> <- Anterior </a>";
                                    echo "  |  ";
                                  }else{
                                      echo " <- Anterior ";
                                      echo "  |  ";
                                  ...
                                  for ($i=0, $p=1; $i<$ccc; $i+=$total_reg, $p++){
                                    echo "<a href='#' onclick=\"Acha('relatorios/previsao_pedido.php','pagina=$p&ordem=$_REQUEST[ordem]&pedidos_clientes_id=$_REQUEST[pedidos_clientes_id]&pedidos_clientes_cc=$_REQUEST[pedidos_clientes_cc]&pos$pos&data_inicial=$_REQUEST[data_inicial]&data_final=$_REQUEST[data_final]','Conteudo');\">";
                                    if ($pc==$p){
                                      echo "<strong>";
                                    }
                                  ...
                                  if ($pc<$fim) {
                                      echo " | ";
                                      echo " <a href='#' onclick=\"Acha('relatorios/previsao_pedido.php','pagina=$proximo&ordem=$_REQUEST[ordem]&pedidos_clientes_id=$_REQUEST[pedidos_clientes_id]&pedidos_clientes_cc=$_REQUEST[pedidos_clientes_cc]&pos$pos&data_inicial=$_REQUEST[data_inicial]&data_final=$_REQUEST[data_final]','Conteudo');\"> Próxima -> </a>";
                                  }else{
                                      echo " | ";
                                      echo " Próxima ->";
                                  }
