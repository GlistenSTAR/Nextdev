                          ...
                          while ($r = pg_fetch_array($not1)){
                            ...
                            */
                            ...
                            <tr bgcolor="<?php echo $Cor;?>" onMouseOver="this.bgColor = '#C0C0C0'" onMouseOut ="this.bgColor = '<?php echo $Cor?>'">
                              ...
                              <?php if ($_REQUEST['tipo']=="rascunhos"){?>
                                <td valign="top" align="center" width="13">
                                  <img src="icones/excluir.png" style="border: 0pt none ; cursor: pointer;" border="0" title="Clique para excluir o ítem" onclick="if (confirm('Deseja realmente excluir esse orçamento?')){ Acha('listar_pedidos.php','acao=Excluir&numero_orcamento=<?php echo $r['numero'];?>','Conteudo'); listarpedidos('rascunhos'); }">
                                </td>
                              <?php }else{?> 
                                <td valign="top" align="center" width="13">
                                  <img src="icones/obs.png" style="border: 0pt none ; cursor: pointer;" border="0" title="Clique para inserir uma Obervação" onclick="Acha('obs_pedido.php','numero=<?php echo $r['numero'];?>','campoobs'); document.getElementById('obs').style.display = 'inline';">
                                </td>                              
                              <?php }?>
                            </tr>
                            <?php
