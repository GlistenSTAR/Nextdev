...
<table border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
  <tr>
    <td>Endereço:</td>
    <td><input name="endereco_entrega" id="endereco_entrega" value="<? echo strtoupper($cep[logradouro]);?>" type="text" size="60" maxlength="50" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.cidade_entrega.focus();}"></td>
  </tr>
  <tr>
    <td>Cidade:</td>
