  ...
  if ($cci>0){
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="texto1" width="100%">
      ...
      while ($r = pg_fetch_array($SqlCarregaItens)){
        ...
        <tr bgcolor="<?php echo $Cor;?>">
          ...
          <td width="25" class="item" align="center">
            ...
            if (!$_SESSION['enviado']){
              ?>
              <img src="icones/alterar.gif" align="center" style="border: 0pt none ; cursor: pointer;" border="0" title="Clique para editar o ítem" onclick="Acha('editar_itens.php', 'numero=<?php echo $numero;?>&codigo=<?php echo $r['codigo']; ?>', 'itens')">
              <?php
            }
            ?>
          </td>
      ...
      <tr>
        ...
        <td align="right" valign="top">&nbsp;</td>
        <td valign="top" align="right"><b><?php echo FormataCasas($TotalPedido,2,false);?></b>&nbsp;</td>
        <td valign="top" align="right"><b><?php echo FormataCasas($TotalIpi,2,false);?></b>&nbsp;</td>
        <td valign="top" align="right"><b><?php echo FormataCasas($TotalPedidoGeral,2,false);?></b>&nbsp;</td>
