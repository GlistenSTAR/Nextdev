                      ...
                      <table border ="0" widht="50%" height="50" class="texto1" align="center">
                        ...
                        <tr>
                          ...
                          <td width="80%">
                            ...
                            <input type="text" size="60" name="cliente_cc" id="cliente_cc" onfocus="this.select()" onkeyup="if (this.value.length>3){Acha1('listar.php','tipo=cliente&valor='+this.value+'','listar_cliente');}">
                            <BR>
              ...
              <table width="580" border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
                <tr>
                  <td>
                    ...
                    <table border = "1" width="100%" class="texto1" cellspacing="2" cellpadding="2">
                      <?php
                      $data_hoje = date("m/d/Y");
                      $consulta = "select numero, valor, emissao, vencimento, pagamento from duplicatas where (vencimento < '$data_hoje') and codigo_do_cliente = $cod_cliente and pago=0  order by vencimento";
