...
if (($numero == "") or ($_REQUEST[t]>1) or ($_REQUEST[t]<0)){
  $_SESSION[erro] = "<span class='erro'>Orçamento não encontrado<BR><BR><a href='javascript:window.close();'>Fechar Janela</a></span>";
                ...
                <fieldset id="titulo-frame">
                  ...
                  <table border="0" class="texto1" width="620">
                    ...
                    <tr>
                      ...
                      <td width="100"><? echo $row->cnpj; ?></font></td>
                        ...
                        <table border = "0" class="texto1" cellspacing="3" cellpadding="3">
                          ...
                          while ($linha = pg_fetch_array($resultado)) {
                            ...
                            <tr class="texto<? echo $Classe;?>">
                              ...
                              <td width="450" style="border: 1px solid #cccccc;"><? echo $linha['descritivo']; ?></td>
