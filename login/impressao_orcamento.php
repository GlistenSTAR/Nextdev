...
if (($numero == "") or ($_REQUEST['t']>1) or ($_REQUEST['t']<0)){
  $_SESSION['erro'] = "<span class='erro'>Or�amento n�o encontrado<BR><BR><a href='javascript:window.close();'>Fechar Janela</a></span>";
  Header("Location: index.php");
}else{
  $consulta = "select * from orcamentos where numero = ".$numero;
                ...
                <fieldset id="titulo-frame">
                  ...
                  <table border="0" class="texto1" width="620">
                    ...
                    <tr>
                      ...
                      <td width="100"><?php echo $row->cnpj; ?></font></td>
                    ...
                    <tr>
                      <td>
                        <table border = "0" class="texto1" cellspacing="3" cellpadding="3">
                          ...
                          #########################################################################
                          $totalipi = 0;
                          $consulta = "select * from orcamentos where numero = '".trim($numero)."'";
                          //echo $consulta;
                          //exit;
                          ...
                          while ($linha = pg_fetch_array($resultado)) {
                            ...
                            <tr class="texto<?php echo $Classe;?>">
                              ...
                              <td width="450" style="border: 1px solid #cccccc;"><?php echo $linha['descritivo']; ?></td>
