...
$CorFundo = "#EFEFEF";
?>
<table width="630" border="0" cellspacing="0" cellpadding="0" class="texto1" align="left" bgcolor="<? echo "$CorFundo";?>">
  <tr>
    <td width="20" bgcolor="<? echo "$CorFundo";?>">&nbsp;</td>
    <td valign="top" bgcolor="<? echo "$CorFundo";?>">
      <table width="600" border="0" cellspacing="0" cellpadding="0" class="texto1" align="center" bgcolor="<? echo "$CorFundo";?>">
        <tr>
          <td valign="top" valign="top" class="texto1" bgcolor="<? echo "$CorFundo";?>">
            <table width="600" border="0" align="center" cellspacing="0" cellpadding="0" class="texto1" background="images/l1_r2_c1.gif" bgcolor="<? echo "$CorFundo";?>">
              <tr>
              ...
              <tr>
                <td colspan="6" valign="top" bgcolor="<? echo "$CorFundo";?>">
                    <table width="600" border="1" align="center" cellspacing="0" cellpadding="2" class="texto1">
                      <tr>
                            ...
                            <table  border="0" style="border: 1px solid #CCCCCC;" align="center" cellspacing="0" cellpadding="2" class="texto1">
                              ...
                              while ($i = pg_fetch_array($SqlCarregaCores)){
                                ...
                                if ($Display){
                                  ...
                                  ?>
                                  <tr bgcolor="<? echo "$Cor";?>" onMouseout="this.style.backgroundColor='<? echo "$Cor";?>';" onmouseover="this.style.backgroundColor='lightgray';" onclick="Adiciona('<? echo $i[codigo];?>','<? echo$i[codigo];?>','codigo');Adiciona('<? echo$i[codigo];?>','<? echo $Produto[nome];?>','descricao');Adiciona('','<? echo$i[valor_unitario];?>','valor_unitario');Adiciona('','<? echo $i[ipi];?>','ipi');document.getElementById('UltimosItens').style.display='none';document.getElementById('qtd_cc').focus();" style="cursor: pointer;">
                                    <td align="left"><?echo "&nbsp;$i[codigo]";?></td>
                                    <td align="left"><?echo "&nbsp;$Pedido[numero]";?></td>
                                    <td align="left"><?echo "&nbsp;$DataPedido";?></td>
                                    <td><? echo "$Produto[nome]";?></td>
                                    <td align="right"><? echo "R$ ".FormataCasas($i[valor_unitario],2,false);?>&nbsp;</td>
                                    <td align="right"><? echo FormataCasas($i[ipi],0,false)." %";?>&nbsp;</td>
                                  </tr>
                                  <?
                                }
                                $ultimo = $i[codigo];
