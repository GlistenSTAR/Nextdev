...
<table border="0" cellspacing="1" cellpadding="1" class="adminform texto1"  width="100%" height="350" valign="top">
  ...
  if ($_REQUEST[busca]){
    ...
    while ($r = pg_fetch_array($not1)){
      ...
      <tr bgcolor="<? echo "$Cor";?>">
        <td align="center">
          <span onmouseover="ddrivetip('<img src=imagens/<? echo $r[imagem];?> width=150 height=150>','#cccccc','150')" onmouseout="hideddrivetip()"><img src="admin/icones/imagens.gif" border="0" width="15" height="15"></span>
        </td>
        <td valign="top">
          <? echo "$r[imagem]";?>
        </td>
