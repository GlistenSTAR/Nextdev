                         ...
                         <form action="" name="cad" METHOD="POST" <? echo $DesativaForm;?>>
                           ...
                           <span style="" name="clientes-corpo1" id="clientes-corpo1">
                              <table width="100%" border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
                                <tr>
                                  ...
                                  <td>
                                    <input name="cnpj" id="cnpj" value="<? echo "$Cgc";?>" type="text" size="20" maxlength="18" onblur="checa(this.value,'document.cad.cnpj')"  onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){checa(this.value,'document.cad.cnpj');document.cad.inscricao.focus();}">
                                    <? echo $Icones;?>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td><input name="inscricao" id="inscricao" value="<? echo "$c[inscricao]";?>" type="text" size="20" maxlength="20" onkeyup="if (!document.cad.cnpj.value){document.cad.cnpj.focus();}if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.nome.focus();}"></td>
                                </tr>
                                <tr>
                                  <td width="100">Nome:</td>
                                  <td><input name="nome" id="nome" type="text" value="<? echo "$c[nome]";?>" size="60" maxlength="50" onkeyup="if (!document.cad.cnpj.value){document.cad.cnpj.focus();}if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.apelido.focus();}"></td>
                                </tr>
                                <tr>
                                  <td width="100">Apelido:</td>
                                  <td><input name="apelido" id="apelido" value="<? echo "$c[apelido]";?>" type="text" size="60" maxlength="60" onkeyup="if (!document.cad.cnpj.value){document.cad.cnpj.focus();}if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.cep.focus();}"></td>
                                </tr>
                                <tr>
                                  <td colspan="2">
                                      ...
                                      <div id="boxendereco" name="boxendereco" style="border:0px;padding=0px; z-index: 1000;">
                                        ...
                                        <table width="100%" border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
                                          <tr>
                                            ...
                                            <td><input name="endereco" id="endereco" value="<? echo $c[endereco];?>" type="text" size="60" maxlength="50" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.cidade.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td width="100">Cidade:</td>
                                            <td><input name="cidade" id="cidade" value="<? echo "$c[cidade]";?>" type="text" size="60" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.bairro.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td width="100">Bairro:</td>
                                            <td><input name="bairro" id="bairro" value="<? echo "$c[bairro]";?>" type="text" size="60" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.estado.focus();}"></td>
                                          </tr>
                                          <tr>
                                ...
                                <tr>
                                  <td width="100">DDD:</td>
                                  <td>
                                    <input name="ddd" id="ddd" value="<? echo "$c[ddd]";?>" type="text" size="2" maxlength="2" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.telefone.focus();}">
                                    &nbsp;&nbsp;&nbsp;Fone:&nbsp;&nbsp;&nbsp;
                                    <input name="telefone" id="telefone" value="<? echo "$c[telefone]";?>" type="text" size="20" maxlength="14" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.fax.focus();}">
                                </tr>
                                  </td>
                                </tr>
                                <tr>
                                  <td width="100">Fax:</td>
                                  <td><input name="fax" id="fax" value="<? echo "$c[fax]";?>" type="text" size="20" maxlength="14" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){trocarAba('clientes-',2,4);setTimeout('document.cad.cep_cobranca.focus()',500);}"></td>
                                </tr>
                              </table>
                           </span>
                              ...
                              <table width="100%" border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
                                <tr>
                                  <td colspan="2" valign="top">
                                    ...
                                    ?>
                                    <input type="checkbox" name="MesmoCobranca" id="MesmoCobranca" onclick="mesmocobranca();" <? echo "$EndPrincipalCob";?>>O mesmo que o principal
                                  </td>
                                </tr>
                                <tr>
                                    ...
                                    <fieldset style="width: 80%; padding: 1; z-index: 1000;">
                                      ...
                                      <div id="boxendereco_cobranca" name="boxendereco_cobranca" style="border:0px;padding=0px;">
                                        <table width="100%" border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
                                          ...
                                          <tr>
                                            <td>Endereço:</td>
                                            <td><input name="endereco_cobranca" id="endereco_cobranca" value="<? echo "$c[local_cobranca]";?>" type="text" size="60" maxlength="50" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.cidade_cobranca.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td>Cidade:</td>
                                            <td><input name="cidade_cobranca" id="cidade_cobranca" value="<? echo "$c[cidade_cobranca]";?>" type="text" size="60" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.bairro_cobranca.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td>Bairro:</td>
                                            <td><input name="bairro_cobranca" id="bairro_cobranca" value="<? echo "$c[bairro_cobranca]";?>" type="text" size="60" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.estado_cobranca.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td width="100">Estado:</td>
                                            <td>
                                ...
                                <tr>
                                  <td>Fone:</td>
                                  <td><input name="telefone_cobranca" id="telefone_cobranca" value="<? echo "$c[tel_cobranca]";?>" type="text" size="60" maxlength="10" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){trocarAba('clientes-',3,4);setTimeout('document.cad.cep_entrega.focus()',500);}"></td>
                                </tr>
                                </tr>
                                <tr>
                              ...
                              <table width="100%" border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
                                <tr>
                                  <td colspan="2" valign="top">
                                    ...
                                    ?>
                                    <input type="checkbox" name="MesmoEntrega" id="MesmoEntrega" onclick="mesmoentrega();" value="" <? echo "$EndPrincipalEnt";?>>O mesmo que o principal
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="2"><hr></hr></td>
                                    ...
                                    <fieldset style="width: 80%; padding: 1; z-index: 1000;">
                                      ...
                                      <div id="boxendereco_entrega" name="boxendereco_entrega" style="border:0px;padding=0px;">
                                        <table width="100%" border="0" cellspacing="2" cellpadding="2" class="texto1" align="center">
                                          ...
                                          <tr>
                                            <td>Endereço:</td>
                                            <td><input name="endereco_entrega" id="endereco_entrega" value="<? echo "$c[local_entrega]";?>" type="text" size="60" maxlength="50" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.cidade_entrega.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td>Cidade:</td>
                                            <td><input name="cidade_entrega" id="cidade_entrega" value="<? echo "$c[cidade_entrega]";?>" type="text" size="60" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.bairro_entrega.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td>Bairro:</td>
                                            <td><input name="bairro_entrega" id="bairro_entrega" value="<? echo "$c[bairro_entrega]";?>" type="text" size="60" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.estado_entrega.focus();}"></td>
                                          </tr>
                                          <tr>
                                            <td width="100">Estado:</td>
                                            <td>
                                ...
                                <tr>
                                  <td>Fone:</td>
                                  <td><input name="telefone_entrega" id="telefone_entrega" value="<? echo "$c[tel_entrega]";?>" type="text" size="60" maxlength="10" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.cnpj_entrega.focus();}"></td>
                                </tr>
                                <tr>
                                  <td>CNPJ/CPF:</td>
                                  <td><input name="cnpj_entrega" id="cnpj_entrega" value="<? echo "$c[cgc_entrega]";?>" type="number" size="20" maxlength="18" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.inscricao_entrega.focus();}"></td>
                                </tr>
                                <tr>
                                  <td>Insc. Est.:</td>
                                  <td><input name="inscricao_entrega" id="inscricao_entrega" value="<? echo "$c[inscricao_entrega]";?>" type="text" size="60" maxlength="20" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){trocarAba('clientes-',4,4);setTimeout('document.cad.contato.focus()',500);}"></td>
                                </tr>
                              </table>
                           </span>
                           <span name="clientes-corpo4" id="clientes-corpo4" style="display: none;">
                              <table width="100%" border="0" cellspacing="2" cellpadding="2" class="texto1">
                                <tr>
                                  <td>Contato:</td>
                                  <td><input name="contato" id="contato" value="<? echo "$c[contato]";?>" type="text" size="20" maxlength="30" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.email.focus();}"></td>
                                </tr>
                                <tr>
                                  <td>E-mail:</td>
                                  <td><input name="email" id="email" value="<? echo "$c[email]";?>" type="text" size="60" maxlength="50" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.homepage.focus();}"></td>
                                </tr>
                                <tr>
                                  <td>Home Page:</td>
                                  <td><input name="homepage" id="homepage" value="<? echo "$c[homepage]";?>" type="text" size="60" maxlength="50" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.observacao.focus();}"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td><input name="codigosuframa" id="codigosuframa" value="<? echo "$c[numero_suframa]";?>" type="text" size="20" maxlength="40" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.cad.trans_cc.focus();}"></td>
                                </tr>
                                <tr>
                                  <td>Transportadora:</td>
                                  <td>
                                    <input type="hidden" name="trans_id" id="trans_id" value="<? echo $c[codigo_transportadora];?>">
                                    <input type="text" size="50" name="trans_cc" id="trans_cc" value="<? echo "$p[transportadora]";?>" onfocus="this.select()" onkeyup="if (window.event){tecla = window.event.keyCode;}else{tecla = event.which;}if(tecla==13){document.ped.condpag1_id.focus();}else{Acha1('listar.php','tipo=trans&valor='+this.value+'','listar_trans');}"><BR>
