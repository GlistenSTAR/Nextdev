...
<form name="listar">
  <div id="listar">
    <table width="100%" height="300" border="0" cellspacing="0" cellpadding="0" class="texto1">
      ...
      <tr>
        <td align="center"><b>Listagem de Orçamentos</b></td>
      </tr>
      <tr>
        <td><img src="images/spacer.gif" width="1" height="3"></td>
      </tr>
                    ...
                    <td>
                      <table width="100%" border="0" cellspacing="1" cellpadding="1" class="texto1" valign="top">
                        ...
                        if ($FiltroData){
                          ...
                          $lista = "Select numero, cliente, data, sum(valor_total) as valor_total from $Tabela where idvendedor in ('3','43','51','52') $FiltroData $NumeroPedido  group by numero, cliente, data $Ordem";
                          //echo $lista;
                            ...
                            <table width="100%" border="0" class="texto1">
                              ...
                              if ($ccc<>""){
                                ...
                                <tr>
                                  ...
                                  $proximo = $pc +1;
                                  if ($pc>1) {
                                    echo "<a href='#' onclick=\"Acha('listar_orcamentos.php','pagina=$anterior&ordem=$_REQUEST[ordem]&pos$pos&data_inicial=$_REQUEST[data_inicial]&data_final=$_REQUEST[data_final]','Conteudo');\"> <- Anterior </a>";
                                    echo "  |  ";
                                  }else{
                                      echo " <- Anterior ";
                                      echo "  |  ";
                                  ...
                                  for ($i=0, $p=1; $i<$ccc; $i+=$total_reg, $p++){
                                    echo "<a href='#' onclick=\"Acha('listar_orcamentos.php','pagina=$p&ordem=$_REQUEST[ordem]&pos$pos&data_inicial=$_REQUEST[data_inicial]&data_final=$_REQUEST[data_final]','Conteudo');\">";
                                    if ($pc==$p){
                                      echo "<strong>";
                                    }
                                  ...
                                  if ($pc<$fim) {
                                      echo " | ";
                                      echo " <a href='#' onclick=\"Acha('listar_orcamentos.php','pagina=$proximo&ordem=$_REQUEST[ordem]&pos$pos&data_inicial=$_REQUEST[data_inicial]&data_final=$_REQUEST[data_final]','Conteudo');\"> Próxima -> </a>";
                                  }else{
                                      echo " | ";
                                      echo " Próxima ->";
                                  }
