 ...
 if(is_numeric($_REQUEST[desconto]) AND $_REQUEST[numero]){
   ...
   $TotalCDesc = ($Vl[valor_total] - $Desconto);
 ...
 <table width="580" border="0" cellspacing="0" cellpadding="0" class="texto1" align="center">
   <tr>
     ...
     <td valign="top">
       <input type="text" name="DescDest" id="DescDest" value="<?= $Desconto;?>" style="width:80px;" onblur="Acha('desconto_destacado.php','desconto='+document.getElementById('DescDest').value+'&numero='+document.ped.numero.value+'','GridDestacado')">
   ...
   <tr>
     ...
     <td valign="top">
       <input type="button" name="at" id="at" value="<?= $TotalCDesc;?>" style="width:80px; text-align:left;">       
     </td>
  </tr> 
   <tr>
