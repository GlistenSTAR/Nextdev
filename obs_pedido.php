...
<form action="" method="post" name="grava">
 <table width="450px" cellpadding="6" cellspacing="0" border="0">
  <tr>
    <td>OBSERVAÇÃO DO PEDIDO <b><?= $_REQUEST[numero];?></b></td>
  </tr>
  <tr>
    <td><textarea name="obs" style="width:460px; height:100px; max-height:100px; max-width:460px;" maxlength="300"><?= $ObsPed[observacao];?></textarea></td>
  </tr>
  <tr>
    <td align="right">
      <input type="button" value="Cancelar" name="cancela" onclick="document.getElementById('obs').style.display = 'none';">    
      <input type="button" value="Gravar" name="gravar" onclick="Acha('obs_pedido.php','numero=<?= $_REQUEST[numero];?>&texto='+document.grava.obs.value+'&edita=1','campoobs');">      
    </td>
  </tr> 
 </table>
</form>