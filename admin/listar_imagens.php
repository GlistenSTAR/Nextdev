...
<table border="0" cellspacing="1" cellpadding="1" class="adminform texto1"  width="100%" height="350">
  ...
  <tr>
    <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<img src="<? echo $site_url;?>icones/imagens.gif" border="0" align="left">
  ...
  while ($r = pg_fetch_array($not1)){
    ...
    <tr bgcolor="<? echo "$Cor";?>">
      <td align="center">
        <span onmouseover="ddrivetip('<img src=../imagens/<? echo $r[imagem];?> width=150 height=150>','#cccccc','150')" onmouseout="hideddrivetip()"><img src="icones/imagens.gif" border="0" width="15" height="15"></span>
      </td>
      <td valign="top">
        <? echo "$r[imagem]";?>
      </td>
      <td valign="top">
        <a href="#" onclick="Acha('editar_imagens.php','localizar_numero=<? echo $r[id];?>','Conteudo');"><? echo "$r[legenda]";?>
        </a>
      </td>
      <td>
        <img src="icones/excluir.png" style="border: 0pt none ; cursor: pointer;" border="0" title="Clique para excluir o ítem" onclick="if (confirm('Deseja realmente excluir essa imagem?')){ Acha('listar_imagens.php', 'acao=excluir&id=<? echo $r[id];?>', 'Conteudo')}">
      </td>
    </tr>
    <?
    if ($pagina){
