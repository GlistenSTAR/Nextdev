...
<table class="adminform" align="center" width="100%" height="600">
  ...
  <tr>
    <td valign="top">&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo $site_url;?>icones/usuarios.png" border="0" align="left">
      <center><h3>Cadastrar vendedor</h3></center><hr></hr>
    </td>
  </tr>
  <tr>
        ...
        <div id="divAbaGeral" xmlns:funcao="http://www.oracle.com/XSL/Transform/java/com.seedts.cvc.xslutils.XSLFuncao">
          <div id="divAbaMeio">
             <table width="580" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
                       <td width="592" colspan="3" valign="top">
                         <form action="index.php" name="cad" METHOD="POST">
                           ...
                           ?>
                           <input type="hidden" name="pg" value="cadastrar_clientes" id="pg">
               ...
               <tr>
                 <td align="center">
                   <input type="button" onclick="if (checa(document.cad.cnpj.value,'document.cad.cnpj')){ acerta_campos('divAbaMeio','Conteudo','cadastrar_vendedor.php',true)}" name="Gravar" value="Gravar">
                   <input type="button" onclick="Acha('vendedor.php','','Conteudo');" name="Cancelar" value="Cancelar">
                 </td>
               </tr>
               <tr>
