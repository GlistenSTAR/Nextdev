...
function SelecionaBase(){
  if(document.getElementById('id_base').value==""){
    alert("Selecione a base de dados no topo da página!");
    return false;
  }else{
    if(document.getElementById('base_selecionada')){
      if(document.getElementById('base_selecionada').value!=document.getElementById('nome_base').value){
        Acha("seleciona_base.php" , 'id_base='+document.getElementById('id_base').value , 'seleciona_base');
        Acha('clientes.php','','Conteudo');
      }
    }else{
      Acha("seleciona_base.php" , 'id_base='+document.getElementById('id_base').value , 'seleciona_base');
      Acha('clientes.php','','Conteudo');
