...
<table border="0" cellspacing="1" cellpadding="1" class="adminform"  width="100%" height="350">
  ...
  <tr>
    <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<img src="<? echo $site_url;?>icones/noticias.gif" border="0" align="left">
          ...
          <table border="0" cellspacing="1" cellpadding="4" class="texto1" valign="top" align="center">
            ...
            if ($FiltroData){
              ...
              while ($r = pg_fetch_array($not1)){
                ...
                <tr bgcolor="<? echo "$Cor";?>">
                  <td valign="top">
                    <a href="#" onclick="Acha('cadastrar_noticias.php','localizar_numero=<? echo $r[id];?>','Conteudo');"><? echo "$r[titulo]";?></a>
                  </td>
                  <td valign="top">
                    <?
                    $Texto = $r[texto];
                  ...
                  <td>
                    <img src="icones/excluir.png" style="border: 0pt none ; cursor: pointer;" border="0" title="Clique para excluir o ítem" onclick="if (confirm('Deseja realmente excluir essa notícia?')){ Acha('listar_noticias.php', 'acao=Excluir&id=<? echo $r[id];?>', 'Conteudo')}">
                  </td>
                </tr>
                <?
                if ($pagina){
